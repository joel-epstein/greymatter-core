...
mesh: meshv1.#Mesh & {
	...
	spec: {
		...
		images: {
			...
			dashboard:   string | *"greymatter.jfrog.io/dev-oci/greymatter-dashboard:6.0.6"
			...
			control_api: string | *"greymatter.jfrog.io/dev-oci/oci/greymatter-control-api:1.8.3"
